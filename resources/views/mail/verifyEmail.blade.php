                                                        ...
                                                        <tbody>
                                                            <tr style="box-sizing:border-box;">
                                                                <td style="box-sizing:border-box;">
                                                                    <a href="{{ $url }}" style="box-sizing:border-box;border-radius:4px;color:#fff;display:inline-block;padding:0.375rem 0.75rem;overflow:hidden;text-decoration:none;border-bottom:1px solid #90CAFF;border-left:1px solid #90CAFF;border-right:1px solid #90CAFF;border-top:1px solid #90CAFF">Verifikasi Email</a>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
